...
public class BrightenByHandService extends Service
implements SensorEventListener {
	...
	public void onCreate() {
		...
		mDefaultScreenOffTimeout = Settings.System.getInt(getContentResolver(), Settings.System.SCREEN_OFF_TIMEOUT, 60000);
		Settings.System.putInt(getContentResolver(), Settings.System.SCREEN_OFF_TIMEOUT, 5000);
		Log.i(TAG, Settings.System.SCREEN_OFF_TIMEOUT + Settings.System.getString(getContentResolver(), Settings.System.SCREEN_OFF_TIMEOUT));
	...
	public void onDestroy() {
		...
		Settings.System.putInt(getContentResolver(), Settings.System.SCREEN_OFF_TIMEOUT, mDefaultScreenOffTimeout);
